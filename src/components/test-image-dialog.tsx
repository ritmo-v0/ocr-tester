...
export function TestImageDialog({ imageUrl, groundTruth, onUpdate }: TestImageDialogProps) {
	...
	const handleSave = () => {
		...
		setIsOpen(false)
		toast("Test image updated", { description: "The test image and ground truth have been updated." })
	}
	...
	const handleFileUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		try {
			...
			toast("Image uploaded", { description: "Image converted to base64 and ready to use." })
		} catch (error) {
	...
	const downloadTestCase = () => {
		...
		toast("Test case exported", { description: "The test case has been exported as a JSON file." })
	}
	...
	const handleFileImport = (e: React.ChangeEvent<HTMLInputElement>) => {
		...
		reader.onload = (e) => {
			try {
				...
				toast("Test case imported", { description: "The test case has been imported successfully." })
			} catch (error) {
				toast.error("Import failed", { description: "Failed to parse the imported file." })
			}
		}
